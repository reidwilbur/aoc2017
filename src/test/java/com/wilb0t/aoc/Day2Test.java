...
public class Day2Test {
  ...
  @Test
  public void testChecksum_case1() {
    assertThat(
        testInst.getChecksum(
            ImmutableList.of(
                ImmutableList.of(5,1,9,5),
  ...
  @Test
  public void testChecksum_input1() {
    assertThat(
        testInst.getChecksum(input1),
        is(53460)
    );
  }

  @Test
  public void testDivChecksum_case1() {
    assertThat(
        testInst.getDivChecksum(
            ImmutableList.of(
                ImmutableList.of(5,9,2,8),
                ImmutableList.of(9,4,7,3),
                ImmutableList.of(3,8,6,5)
            )
        ),
        is(9)
    );
  ...
  @Test
  public void testDivChecksum_input1() {
    assertThat(
        testInst.getDivChecksum(input1),
        is(282)
    );
  }
}
